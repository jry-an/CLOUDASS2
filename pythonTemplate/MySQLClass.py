...
mydb = mysql.connector.connect(host="localhost", user="aaron", passwd="aaron",unix_socket='/cloudsql/cloudcoursedelivery:australia-southeast1:universities', database="universities", port=3306)
